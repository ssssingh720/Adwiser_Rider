...
//        AddSiteDetailPrefs.addFormData(context, mySiteDetailVo);
    ...
    private void submitSiteImage() {
        ...
        MySiteImageVo mySiteImageVo = new MySiteImageVo(mySiteDetailVo.getId(), mySiteDetailVo.getAllocationId(), mStoredImagePath, "" + System.currentTimeMillis(),
                ...
                "" + System.currentTimeMillis() + ".jpg", edtImgRemarks.getText().toString().trim(), true, true, mySiteDetailVo.getType());
    ...
    private void captureImageFromCamera() {
        if (mySiteDetailVo.getRange() == 0 || calculateDistance() <= mySiteDetailVo.getRange()) {
    ...
    private float calculateDistance() {
        ...
        try {
            ...
            android.location.Location.distanceBetween(latitude, longitude, Double.valueOf(mySiteDetailVo.getLattitude()),
                    Double.valueOf(mySiteDetailVo.getLongitude()), result1);
