 ...
 */
public class OfflineCaptureSiteImage extends AppBaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = OfflineCaptureSiteImage.this;
...
//        AddSiteDetailPrefs.addFormData(context, mySiteDetailVo);
    ...
    private void submitSiteImage() {
        ...
        MySiteImageVo mySiteImageVo = new MySiteImageVo(mySiteDetailVo.getId(), "allocation_id", mStoredImagePath, "" + System.currentTimeMillis(),
                ...
                "" + System.currentTimeMillis() + ".jpg", edtImgRemarks.getText().toString().trim(), true, false,"Not available");
    ...
    private void captureImageFromCamera() {
        if (android.os.Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            intent.putExtra(MediaStore.EXTRA_OUTPUT, FileProvider.getUriForFile(this, OfflineCaptureSiteImage.this.getApplicationContext().getPackageName() + ".provider", f));
    ...
    public void onBackPressed() {
        ...
        if (isImageCompulsary) {
            if (isOneImageUploaded) {
                setResult(RESULT_OK);
                OfflineCaptureSiteImage.this.finish();
    ...
    private void getLocation() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (Util.checkPermission(OfflineCaptureSiteImage.this, Manifest.permission.ACCESS_FINE_LOCATION)) {
//                callLocationManager();
                getUpdatedLocation();
            } else {
                if (!ActivityCompat.shouldShowRequestPermissionRationale(OfflineCaptureSiteImage.this, Manifest.permission.ACCESS_FINE_LOCATION)) {
...
//                Utils.stopProgress(progressDialog);
    ...
    private void getUpdatedLocation() {
        ...
        if (gps.canGetLocation()) {
            ...
            new GpsActivation(OfflineCaptureSiteImage.this).enableGPS();
        }
    }
}
